...
I have made a [Jupyter Notebook template](https://github.com/whyjz/ncu-env-data-science/blob/main/docs/project.ipynb) for you to automatically publish your Jupyter notebook (or plain markdown files) using GitHub Pages. You can also find the deployed [HTML here](https://whyjz.github.io/ncu-env-data-science/project.html). 
